...
Manta is part of the DataLeap platform for data profiling and quality management. This CLI provides commands to create profiling rules and authenticate with DataLeap Manta.

Supported regions: `cn`, `sg`, `va`, `eu`.
